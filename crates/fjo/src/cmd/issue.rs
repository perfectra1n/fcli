...
//! `create`/`edit` orchestrate several calls. What layer 2 cannot do is the point — `fjo raw
...
//!
//! ```text
//! fjo issue depends list 42            # what blocks #42, and what #42 blocks
...
creating branches from issues.
  ...
  fjo issue list -s all -l bug
  fjo issue create --title 'It broke' -b 'here is how' -a @me -m 1.0
  fjo issue view 42 --comments
  fjo issue edit 42 --add-label bug --remove-assignee @me
  fjo issue depends add 42 --blocked-by 7";
...
pub struct CommentArgs {
    ...
    /// not an issue number — as printed by `fjo issue view --comments`
