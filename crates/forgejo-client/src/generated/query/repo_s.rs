...
pub struct RepoSearchQuery {
    ...
    /// is not specified.
    ///
    /// Known values: `asc`, `desc`. Not enforced — a newer server may accept others.
    ...
    ///
    /// Known values: `alpha`, `created`, `updated`, `size`, `git_size`, `lfs_size`, `id`, `stars`, `forks`. Not enforced — a newer server may accept others.
