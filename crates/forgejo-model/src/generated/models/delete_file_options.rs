...
//! `DeleteFileOptions`, as declared in the Forgejo API specification.
...
/// and `committer` are optional (if only one is given, it will be used for the other, otherwise the
